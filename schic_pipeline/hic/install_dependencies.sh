...
conda create -n bds_atac --file requirements.txt -y -c defaults -c conda-forge -c bioconda -c r -c bcbio -c daler -c asmeurer
# conda create -n ${ENV_NAME_PY3} --file requirements_py3.txt -y -c defaults -c conda-forge -c bioconda -c r -c bcbio -c daler -c asmeurer
...
cd $CONDA_EXTRA
git clone --branch 2.0.4.2 git://github.com/kundajelab/idr
cd idr
